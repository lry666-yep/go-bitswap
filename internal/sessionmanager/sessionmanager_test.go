...
func (fs *fakeSession) ReceiveFromWithGeo(p peer.ID, ks []cid.Cid, wantBlocks []cid.Cid, wantHaves []cid.Cid, l bsmsg.Location, d float64) {
...
func TestReceiveFrom(t *testing.T) {
	...
	l.Lat = 33.33
	l.Lng = 55.55
	sm.ReceiveFromWithGeo(ctx, p, []cid.Cid{}, []cid.Cid{block.Cid()}, []cid.Cid{}, l, d)
	...
	sm.ReceiveFromWithGeo(ctx, p, []cid.Cid{}, []cid.Cid{}, []cid.Cid{block.Cid()}, l, d)
